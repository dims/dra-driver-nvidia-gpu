...
func TestPersistentAgentRuntimeSelectsAndReusesOneChildConfiguration(t *testing.T) {
	...
	first := &ControllerSnapshotDesiredState{
		ComputeDomainUID: types.UID("domain-a"), CliqueID: "clique-a", Protocol: nvapi.ComputeDomainCliqueProtocolPersistentAgentV1,
	}
	...
	second := &ControllerSnapshotDesiredState{
		ComputeDomainUID: types.UID("domain-b"), CliqueID: "clique-a", Protocol: nvapi.ComputeDomainCliqueProtocolPersistentAgentV1,
	}
