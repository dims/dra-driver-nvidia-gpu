...
func (m *PersistentAgentManager) PrepareComputeDomainRetirement(ctx context.Context, cd *nvapi.ComputeDomain) (bool, error) {
...
func (m *PersistentAgentManager) snapshotWorkloadsQuiesced(ctx context.Context, cd *nvapi.ComputeDomain, snapshot *nvapi.ComputeDomainCliqueSnapshot) (bool, error) {
	...
	// the persistent-agent workload template. Pod deletion or a terminal phase
...
func (m *PersistentAgentManager) snapshotRetirementEvidenceComplete(ctx context.Context, snapshot *nvapi.ComputeDomainCliqueSnapshot) (bool, error) {
...
func (m *PersistentAgentManager) validateRetirementEvidence(ctx context.Context, snapshot *nvapi.ComputeDomainCliqueSnapshot, member *nvapi.ComputeDomainCliqueMember, evidence *nvapi.ComputeDomainCliqueRetirementEvidence) error {
